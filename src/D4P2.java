...
public class D4P2 {
    ...
    public static ArrayList<Integer> aEliminar;
    ...
    public static void solve() throws IOException {
        ...
        // Creamos una lista para recoger qué celdas eliminaremos en cada iteración:
        aEliminar = new ArrayList<>();

        // Añadimos un elemento "basura" a 'aEliminar' para entrar en el bucle:
        aEliminar.add(0);

        /*
         * Mientras queden celdas por eliminar, las eliminamos y añadimos al conteo
         * cuántos hemos eliminado:
         */
        while (!aEliminar.isEmpty()) {
            aEliminar = new ArrayList<>();
            for (int i = 0; i < n * n; i++) {
                if (grafo[i]) {
                    vecinos(i);
    ...
    public static void vecinos(int nodo) {
        ...
        for (int i : alrededores) {
            for (int j : alrededores) {
                ...
                if (vecino) {
                    ...
                    /*
                     * Si el número de vecinos llega a los 4, ya sabemos que no se eliminará el
                     * nodo:
                     */
                    if (vecinos == 4)
                        return;
         ...
         * menor que 4, así que lo eliminamos:
         */
        aEliminar.add(nodo);
    }
